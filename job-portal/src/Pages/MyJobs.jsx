...
const MyJobs = () => {
    ...
    useEffect(() => {
        setIsLoading(true);
        fetch(`http://localhost:3000/MyJobs/oshagaras@gmail.com`).then(res => res.json()).then(data => {
            setJobs(data);
            setIsLoading(false);
        })
    },[searchText]);
  ...
  return (
    <div className="max-w-screen 2xl container mx-auto xl:px-24 px-4">
      <div className="my-jobs-container">
        <h1 className="text-center py-4">ALL My Jobs</h1>
